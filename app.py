...
if archivo is not None:
    ...
    # Base de datos limpia: Solo pacientes que sí generaron actividad
    ...
    # Recuento global para Costo Máquina Ecografía
    ...
    # Ecuación corregida de costo real para la clínica
    ...
    st.subheader("3. Detalle Servicios Ecoguiados (Automático)")
