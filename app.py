...
if archivo is not None:
    ...
    eco_data = [
        {"Servicio": "EPI", "Cobro a Cliente": "$45.000", "Ingreso Bruto Total": f"${ingreso_epi_bruto:,.0f}", "Costo Máquina": "$18.000", "Cantidad": cant_epi_global, "Costo Total Máquina": f"${cant_epi_global * 18000:,.0f}"},
        {"Servicio": "Ev. Ecográfica", "Cobro a Cliente": "$25.000", "Ingreso Bruto Total": f"${ingreso_eco_bruto:,.0f}", "Costo Máquina": "$10.000", "Cantidad": cant_eco_global, "Costo Total Máquina": f"${cant_eco_global * 10000:,.0f}"}
    ]
    ...
    # Adición de las filas solicitadas inmediatamente debajo del ingreso inicial
    datos_resumen = [
